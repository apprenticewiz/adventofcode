       ...
       CHECK-PROP1.
           MOVE "N" TO PROP1
           PERFORM VARYING I FROM 1 BY 1 UNTIL I > (LINE-LEN - 3)
               MOVE INPUT-RECORD(I:2) TO PAIR1
               COMPUTE START-J = I + 2
               PERFORM VARYING J FROM START-J BY 1
                 UNTIL J > (LINE-LEN - 1)
                   MOVE INPUT-RECORD(J:2) TO PAIR2
                   IF PAIR1 = PAIR2
                       MOVE "Y" TO PROP1
                       EXIT PERFORM
                   END-IF
       ...
       CHECK-PROP2.
           ...
           PERFORM VARYING I FROM 1 BY 1 UNTIL I > (LINE-LEN - 2)
               ...
               MOVE INPUT-RECORD(I + 2:1) TO NEXT-CHAR
