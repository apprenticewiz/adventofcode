       ...
       UPDATE-OPS.
         PERFORM VARYING I2 FROM 1 BY 1 UNTIL I2 > OPS-LAST-PTR
           IF FUNCTION TRIM(OP-DEST(I2)) = "b" THEN
               MOVE "ASSIGN" TO OP-OPER(I2)
               STRING TOTAL DELIMITED BY SIZE INTO TEMP-STR
               MOVE TEMP-STR TO OP-SRC1(I2)
           END-IF
           MOVE "N" TO OP-SOLVED(I2)
         END-PERFORM.
