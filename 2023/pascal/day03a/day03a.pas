...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                AdjRow := NumLoc.Pos.Row + DeltaRow;
                ...
                BEGIN
                    ...
                    BEGIN
                        ...
                        IF (AdjRow = PartLoc.Pos.Row) AND (AdjCol = PartLoc.Pos.Col) THEN
                        BEGIN
                            Found := TRUE;
                            BREAK
                        END;
        ...
        BEGIN
            NumVal := 0;
            FOR I := 1 TO 3 DO
                IF (NumLoc.Number[I] >= '0') AND (NumLoc.Number[I] <= '9') THEN
                    NumVal := NumVal * 10 + Ord(NumLoc.Number[I]) - Ord('0');
            Res := Res + NumVal
        END;
